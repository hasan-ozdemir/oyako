...
public static class EnvFileLoader
{
    private static readonly Dictionary<string, string[]> Aliases = new(StringComparer.OrdinalIgnoreCase)
    {
        ...
        ["web_document_request_timeout_seconds"] = ["Crawler__RequestTimeoutSeconds"],
        ["web_document_render_timeout_seconds"] = ["Crawler__RenderTimeoutSeconds"],
        ["web_document_render_stabilization_timeout_seconds"] = ["Crawler__RenderStabilizationTimeoutSeconds"],
        ["web_document_minimum_request_delay_milliseconds"] = ["Crawler__MinimumRequestDelayMilliseconds"],
        ["web_document_maximum_request_delay_milliseconds"] = ["Crawler__MaximumRequestDelayMilliseconds"],
        ["web_document_source_refresh_startup_jitter_seconds"] = ["Crawler__SourceRefreshStartupJitterSeconds"],
